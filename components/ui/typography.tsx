...
const typographyVariants = {
  ...
  p1: "font-sans text-[clamp(1.5rem,3vw,2.5rem)] font-normal leading-none tracking-[-0.02em] text-brand-dark",
  p2: "font-sans text-[clamp(1.375rem,2.5vw,1.875rem)] font-normal leading-none tracking-[-0.02em] text-brand-dark",
  /** Contact details / compact emphasis — Figma 24px Inter */
  p2Small:
    "font-sans text-2xl font-normal leading-none tracking-[-0.02em] text-brand-dark",
  body: "font-sans text-lg font-normal leading-5 text-brand-dark",
